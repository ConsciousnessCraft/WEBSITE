...
export default function Expertise() {
    ...
    return (
      <section
        className="relative p-6 sm:p-10 text-center max-w-full mx-auto bg-gradient-to-r from-black via-gray-800 to-gray-600 rounded-xl shadow-lg overflow-hidden"
